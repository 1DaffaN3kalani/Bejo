    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = [" Tag lagi wajib bayar pajak ☞   ",cName + " Tag Lagi aku Cipok ☞ ",cName + " Njirr Tag mulu Ane Sibuk ☞ ",cName + " Kangen ya tag Mulu P c aja ☞ ",cName + " Sekali Tag lagi gua gampar ☞ "]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                cl.sendMessage(msg)
                ki.sendText(msg.to,"[Cie..Cie..Bos Ane pamer Contact\njangan lupa Add Ye Orangnya baik&tidak sombong😁😁]")

...
cl = LINETCR.LINE()
cl.login(token="EpWizfih4tepViqt0OJ8.fjSIf69Wywe4OCILM+Z4Qa.zZJqEy+TIpK0Cf7F6fX3pJR1vLTA29z6nfJhYyaliOw=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = [" Bentar Aku masih sibuk patalan sama bapaknya Radisti ☞   ",cName + " Dont Tag Me please!! Im Busy ☞ ",cName + " Ngapain Ngetag Kak?\nKalo perlu penting P c  bojoku aja ya ☞ ",cName + " Nggak Usah Tag-Tag mulu!!\nKalo Penting Langsung P C Bojoku Aja Kak ☞ ",cName + " Kenapa Tag Aku kak?\nKalo penting PC Bojoku Aja Ya ☞ "]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     cName = contact.displayName
                     image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                     balas = [" Bentar aku masih Patalan sama bapaknya Radisti ☞   ",cName + " Dont Tag Me!! Im Busy ☞ ",cName + " Ngapain Ngetag Kak?\nKalo perlu penting P c Bojoku aja ya ☞ ",cName + " Nggak Usah Tag-Tag mulu!!\nKalo Penting Langsung P C Bojoku Aja Kak ☞ ",cName + " Kenapa Tag Aku kak?\nKalo penting P C Bojoku Aja Ya ☞ "]
                     ret_ = "" + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     tts = gTTS(text=ret_, lang='id')
                     tts.save('tts.mp3')

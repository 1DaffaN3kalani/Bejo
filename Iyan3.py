...
cl = LINETCR.LINE()
cl.login(token="EpADXTdwMJ2wZ4j6mqdc.Kt5H3TtLzsAEuxw6pG1Qxa.y+86+OxNIZOn9TDCSAcjVWxVXp3D6VfJkrPoQ1B+KV8=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpqotlAVcFiHvGP9HGN7.kzkA/mJ7j2NORGxAyX4VrW.AaAeOmVBhTWxEwovjRuLGCgP2sOlt1xNM1TbTgeYzNo=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EpoYB7TkvGVi0Gc2dDT8.4lc0INkFmn1dPSo6/r1F6a.BAtuCWGbNKwrBYR6wid+JCl/+ZaBSlKfoole9T9Ezn8=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EploWLiwkVN4cr5o3bHc.m3YZKrKxuzs9oG1bTEngBa.XiZMmZcC8FFDb94m931j6rY6bp8rUnzNTD0WbIOx0zI=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="EptPu51BDoNMJ0ivL39d.PDgYVXiSTRGdj3fF0E5Jdq.CiPoT64T6DzIze4kuHEgM4NlP/k3lkZteTt4i6OBI4c=")
kl.loginResult()

...
cl = LINETCR.LINE()
cl.login(token="EptwkbiNfViFwVFwjzod.WasAeNdlKmHmz+4A199udq.V+9eNR2JgdLPlBkorV1ZAaTsol4Jf9gunApDvrbNUFA=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Ep3plmyJxEeReTc0W9V1.PzWLtZpApBK80zdsW9GK8q.z+N7G8V+gVywZhTf4qjisvB8S7DwT3VMW/IiygNiFP8=")
ki.loginResult()

...
cl = LINETCR.LINE()
cl.login(token="Ep7ROa6axwkfpfVXfHq7.0WNskYIjCCQ4Eaf4A515jW.gryRFmd0ILK72LIHkUhRAxsptA6D6tcOmM/fV97nMSg=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpsKEzjI2n7puMGXb5p4.7BA+6NT5YBWKoemyKGKjLa.6SeNn0JNLCyOKqwMMZ0QImDN4ii+VLp2w5WPoJlEmEY=")
ki.loginResult()

        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMentionPc"] == True:
                     ...
                     balas = [" Yes, I'm here\nCan I help you... ☞   ",cName + " Jangan tag dulu lagi nanggung  ☞ ",cName + " Tag aja gak usah p c ya ☞ ",cName + " Hai Jones... Suka Amat tag aku ☞ ",cName + " Tag lagi Dan lagi lagi lagi lagi ☞ "]

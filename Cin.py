...
cl = LINETCR.LINE()
cl.login(token="Ep6xb431smegFJrDYoOb.nkn/0ETcVOiA0C/0T2GhsW.XALXn+DJjQYhTgT1hvpyNYQY4iGqt4wmg5/mcYIcsTM=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpyUozwpHciUOi60VZma.BUig7oBYwOouvWBb6Tm4QG.3B4AZszVTMw8h3+f/u5Fod26YVakkjbcnvq6sERAa/A=")
ki.loginResult()

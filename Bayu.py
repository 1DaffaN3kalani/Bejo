...
cl = LINETCR.LINE()
cl.login(token="Epb7s607xkllQYFOBVS1.MMQ0PQRSgfipQwOJprZhuq.ZcrVwWudsBlp4MPjTCb6oKalFCnDsTd2BWJezMHVStg=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpcExj0p3ndHEnwwy08e.3kABypr/N0MVLtAkD2f33G.4gXrWQrvfLzm4HGjzScXFB16b87wtcmNcznN8g65wXU=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Epbvm5XAEwCzJ9xTS1V9.SkQIO5yvCY4fHJJlYe9C6q.47Z8Z8tEgK2Zoona0OiwrdpzBn14QhIcruhKCjy19eg=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Epizk8OsO4ghM1aCHIy4.8drSMrbedHQ8SDWWf8yY9a.u5qRQbv5eKkV/EvF5VVfUANLyb5RUk0V0zPI73jP1jk=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="EpAR9F9KNaYmwygSxVs5.EyL+LkxpcIeYtbSiim8M5q.dmBeoyYs9NXnxgOV6nv09zCLXlvEGtknhY+bs/IyZlw=")
kl.loginResult()

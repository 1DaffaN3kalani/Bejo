...
cl = LINETCR.LINE()
cl.login(token="Ep1aKqWr62ntnv7i7jna.rxV3/qJUjxP7xPVG4yaDIG.TO+j4GBRlTdiiuaZqzK+2RVb5gOrbw87YVpy+HI4tsk=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpkbMEYMgVQyZGghcsw8.m374ljfzDVqquTbS30/Fca.3cw8yTQut234QmFMJgoB952SySdNB6l6Wdmi6E06k/U=")
ki.loginResult()

...
cl = LINETCR.LINE()
cl.login(token="EpYn2q1ZfiYuMHcR5vk6.fTKCLmFlBfpEHyAxbVypLG.iyRkN5JmNjcnTY1h7gBqm9kPShdY6ATv9Xzk+Ci2+8w=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpfuwMOkfKAoQOHdiSi9.yx+t2VJzkRNdlPU2RlUb2q.JIWkq/LXjMh++YjxJh3YSn6gMBZGjoglhZT2bM38PF4=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EpBsY7X4QOgOkLouXawa.Dhdy2GKcCS4nNmLJCaNpcG.PjpDcV9iL31d+mT60aupt62nqgjn6LykbHyokTr5hSA=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EpiOWJPfLTaXIMQDQ8H6.l1sUJRZN2Plp7X7G+jey9G.ERrzXEIm0Dr9ih2RlCzcuKsIPrAoMWzjxmaIuR1wOHA=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="Epikllru8TMwgEdoeBg2.YKQ148h2BP5FIRLn7L3/4G.TV1e+4xGIwz2lQ/ZGrgUplrNih65wIayoZY/dOdhT3E=")
kl.loginResult()
